...
export function BubbleMap({ votes }: BubbleMapProps) {
  ...
  if (votes.length === 0) {
    return (
      <div className="rounded-2xl border border-border/40 bg-card p-12 shadow-elevation-2 flex h-96 items-center justify-center text-muted-foreground">
        No votes available
      </div>
    );
  }
  ...
  return (
    <div className={
      isGame
        ...
        : "rounded-2xl border border-border/40 bg-card p-2 sm:p-3 shadow-elevation-2 overflow-visible dark:rounded-none dark:border-[#0bd1a2] dark:bg-transparent dark:shadow-none"
    }>
          ...
          <Button
            ...
            className={
              isGame
                ...
                : "h-8 sm:h-9 rounded-2xl border border-border/40 bg-card shadow-elevation-2 dark:rounded-none dark:border-[#0bd1a2] dark:bg-transparent dark:text-[#0bd1a2] dark:shadow-none"
            }
          >
            ...
            <Button
              ...
              className={
                isGame
                  ...
                  : "h-8 sm:h-9 rounded-2xl border border-border/40 bg-card shadow-elevation-2 text-xs dark:rounded-none dark:border-[#0bd1a2] dark:bg-transparent dark:text-[#0bd1a2] dark:shadow-none"
              }
            >
              Reset
            </Button>
          ...
          <div
            className={
              isGame
                ...
                : "absolute z-50 rounded-2xl border border-border/40 bg-card px-4 py-3 text-xs shadow-elevation-2 pointer-events-none"
            }
            style={{
