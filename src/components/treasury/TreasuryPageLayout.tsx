...
const NAV_TABS = [
  { href: "/treasury", label: "tabSpending" },
  { href: "/treasury/entities", label: "tabFundedEntities" },
] as const;

interface TreasuryPageLayoutProps {
  initialData: InitialGovernanceData;
  children: ReactNode;
}

export default function TreasuryPageLayout({ initialData, children }: TreasuryPageLayoutProps) {
