# Governance Voting Reference

This document tracks canonical voting rights for each governance action type.
The table is derived from CIP-1694 materials and the reference table shared in
design discussions (see latest screenshot in the design thread).

| Governance Action                                             | SPOs | DReps | CC |
| ------------------------------------------------------------- | :--: | :---: | :-: |
| Motion of No-Confidence                                       |  ✓   |   ✓   |  ✗ |
| New Constitutional Committee and/or Threshold/Terms           |  ✓   |   ✓   |  ✗ |
...
- ✓ – role participates in voting on this action type.
- ✗ – role has no vote for this action type (UI must hide any statistics for the role).

These rules should be encoded in the UI to determine when to display the SPO / DRep /
CC donut charts, tables, bubble maps, etc. Update this file whenever governance
logic changes so that engineering work stays in sync with policy.
...
Protocol parameter updates use transaction field nº6 of the transaction body.
...
2. Update committee and/or threshold and/or terms
...
SPOs
The SPO vote threshold which must be met as a certain threshold of the total active voting stake, excepting Hard Fork Governance Actions. Due to the need for robust consensus around Hard Fork initiations, these votes must be met as a percentage of the stake held by all stake pools.
...
governance voting thresholds (P1, P2a, P2b, P3, P4, P5a, P5b, P5c, P5d, P6, Q1, Q2a, Q2b, Q4, Q5)
