...
|-------|---------------|-------|
| **Light** | Multi-color palette | Rounded corners, shadows, warm background |
| **Dark** | Cyan (#0bd1a2) | Sharp corners, borders, transparent background |
| **Game** | White/grayscale | Retro pixel-art style |

**Key principle:** Dark theme uses cyan (#0bd1a2) for almost everything. Game theme uses white/gray scale.
...
<div style={{ left, top, width, height, zIndex }}>
  ...
  {/* Inner wrapper with theme-aware border */}
  <div className={cn(
    "h-full w-full overflow-hidden rounded-2xl",
    isDark ? "border border-[#0bd1a2]" : "border border-white/8 shadow-..."
  )}>
...
11. [ ] Test drag/resize in dashboard view
12. [ ] Verify chart appears in visibility dropdown
