...
**Key principles:**
- Dark theme uses cyan (#0bd1a2) for almost everything
- Game theme uses white/grayscale only
- **Game theme cards have NO colored borders** - use `border-none` for game theme
  ...
  <div className={cn(
    ...
    isGame
      ...
      : isDark
        ...
        : "rounded-2xl border border-white/8 bg-[#faf9f6] shadow-..."  // Light: subtle border
  )}>
